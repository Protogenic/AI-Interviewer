...
from config import MODEL_NAME, DEVICE, GENERATION_CONFIG, ENABLE_THINKING
...
class AIInterviewer:
    ...
    def _load_model(self) -> None:
        ...
        # Безопасная загрузка без 8bit (работает везде)
        ...
        print(f"Модель загружена на {self.config.device}")
