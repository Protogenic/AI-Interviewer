...
@pytest.mark.asyncio
async def test_generate_question_dud() -> None:
...
@pytest.mark.asyncio
async def test_generate_question_sobchak() -> None:
    transport_app = ASGITransport(app=app)
...
@pytest.mark.asyncio
async def test_generate_question_pozner() -> None:
    transport_app = ASGITransport(app=app)
    ...
    data = response.json()
    assert "question" in data
    assert data["used_profile"] == "pozner"
